    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-orange-50 to-white">
      ...
      <section className="relative min-h-[70vh] flex items-end overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-amber-900 via-orange-800 to-red-900">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-yellow-400 via-amber-300 to-yellow-400" />
        </div>
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-4 pb-16">
          ...
          <motion.nav
            ...
            className="flex items-center gap-2 text-sm text-amber-200 mb-6"
          >
            ...
            {post.city && relatedLinks?.cityTours && (
              <>
                <Link href={relatedLinks.cityTours} className="hover:text-yellow-400 transition-colors">
                  {post.city.charAt(0).toUpperCase() + post.city.slice(1)}
                </Link>
                <ChevronRight className="w-4 h-4" />
              </>
            )}
            <span className="text-white">Fort & Palace</span>
          </motion.nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <main className="lg:col-span-8">
            ...
            <motion.div
              ...
              className="relative w-full h-[400px] md:h-[500px] rounded-2xl overflow-hidden mb-8 shadow-2xl border-4 border-amber-200"
            >
              <Image
                src={post.image || '/images/placeholder-fort.jpg'}
                alt={post.title}
                fill
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-6">
                <div className="flex items-center gap-2 text-yellow-400">
                  ...
                  <span className="font-bold">UNESCO World Heritage Site</span>
                </div>
              </div>
            </motion.div>
