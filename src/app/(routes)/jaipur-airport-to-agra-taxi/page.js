...
export const metadata = {
  ...
  keywords: 'jaipur airport to agra taxi, jaipur airport agra cab, jaipur to agra transfer, golden triangle taxi, taj mahal from jaipur',
  ...
  openGraph: {
    title: `Jaipur Airport to Agra Taxi | Fixed Fare \u20B9${data.fares.sedan.price} | Golden Triangle`,
    description: `Book taxi from Jaipur Airport to Agra. Fatehpur Sikri stop available, Golden Triangle route. ${data.time}.`,
    type: 'website', locale: 'en_IN', url: `https://www.trivenicabs.in/${SLUG}`, siteName: 'Triveni Cabs',
  },
  twitter: { card: 'summary_large_image', title: `Jaipur Airport to Agra Taxi | \u20B9${data.fares.sedan.price}`, description: 'Jaipur to Agra airport transfer. Golden Triangle route.' },
