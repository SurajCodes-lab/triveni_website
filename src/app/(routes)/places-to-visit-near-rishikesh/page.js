...
export const metadata = {
  ...
  openGraph: { title: '15+ Places to Visit Near Rishikesh by Car | Book Cab', description: 'Adventure and Himalayan retreats from Rishikesh. Haridwar, Mussoorie, Chopta, Auli & more.', type: 'website', locale: 'en_IN', url: 'https://www.trivenicabs.in/places-to-visit-near-rishikesh', siteName: 'Triveni Cabs', images: [{ url: '/images/citypage_hero_section_image.jpg', width: 1200, height: 630, alt: 'Places to Visit Near Rishikesh' }] },
  twitter: { card: 'summary_large_image', title: '15+ Places to Visit Near Rishikesh | Triveni Cabs', description: 'Adventure and spiritual trips from Rishikesh. Call 7668570551.', images: ['/images/citypage_hero_section_image.jpg'] },
