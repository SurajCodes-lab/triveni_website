...
const SLUG = 'dehradun-airport-to-mussoorie-taxi';
const data = airportRoutes[SLUG];

export const metadata = {
  title: `Dehradun Airport to Mussoorie Taxi | Fixed \u20B9${data.fares.sedan.price} | Quick Transfer`,
  description: `Dehradun Jolly Grant Airport to Mussoorie taxi. Fixed fare sedan \u20B9${data.fares.sedan.price}, SUV \u20B9${data.fares.suv.price}. Scenic mountain drive. ${data.time}. Call 7668570551.`,
  keywords: 'dehradun airport to mussoorie taxi, jolly grant airport mussoorie cab, dehradun to mussoorie transfer, mussoorie airport taxi',
  ...
  openGraph: {
    title: `Dehradun Airport to Mussoorie Taxi | Fixed Fare \u20B9${data.fares.sedan.price}`,
    description: `Book taxi from Jolly Grant Airport to Mussoorie. Quick mountain transfer. ${data.time}.`,
    type: 'website', locale: 'en_IN', url: `https://www.trivenicabs.in/${SLUG}`, siteName: 'Triveni Cabs',
  },
  twitter: { card: 'summary_large_image', title: `Dehradun Airport to Mussoorie Taxi | \u20B9${data.fares.sedan.price}`, description: 'Jolly Grant Airport to Mussoorie. Quick hill transfer.' },
