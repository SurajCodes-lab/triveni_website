...
export const metadata = {
  ...
  alternates: { canonical: '/varanasi-vs-haridwar' },
  openGraph: {
    title: data.title,
    description: data.metaDescription,
    type: 'article',
    locale: 'en_IN',
    url: 'https://www.trivenicabs.in/varanasi-vs-haridwar',
...
export default function VaranasiVsHaridwarPage() {
  const breadcrumbSchema = {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "itemListElement": [
      { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://www.trivenicabs.in" },
      { "@type": "ListItem", "position": 2, "name": "Varanasi vs Haridwar", "item": "https://www.trivenicabs.in/varanasi-vs-haridwar" },
    ],
  };
