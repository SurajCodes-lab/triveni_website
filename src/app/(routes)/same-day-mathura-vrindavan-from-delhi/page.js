...
export const metadata = {
  ...
  keywords: 'same day mathura vrindavan tour from delhi, delhi to mathura one day trip, delhi to vrindavan cab, krishna janmabhoomi tour',
  authors: [{ name: 'Triveni Cabs' }],
  metadataBase: new URL('https://www.trivenicabs.in'),
  alternates: { canonical: '/same-day-mathura-vrindavan-from-delhi' },
  openGraph: {
    title: 'Same Day Mathura Vrindavan Tour from Delhi | ₹4,000 AC Cab',
    description: 'Delhi to Mathura Vrindavan day trip. Krishna Janmabhoomi, Banke Bihari, ISKCON Temple. AC sedan ₹4,000.',
    type: 'website', locale: 'en_IN', url: 'https://www.trivenicabs.in/same-day-mathura-vrindavan-from-delhi', siteName: 'Triveni Cabs',
  },
  twitter: { card: 'summary_large_image', title: 'Same Day Mathura Vrindavan Tour | ₹4,000', description: 'Delhi to Mathura Vrindavan day trip. Book now!' },
