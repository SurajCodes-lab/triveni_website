...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: '/images/sightseeing/Jodhpur/Mehrangarh Fort.jpg', width: 1200, height: 630, alt: 'Jodhpur Beyond Mehrangarh' }],
  },
  twitter: {
    ...
    creator: '@trivenicabs',
    site: '@trivenicabs',
    images: ['/images/sightseeing/Jodhpur/Mehrangarh Fort.jpg'],
  },
