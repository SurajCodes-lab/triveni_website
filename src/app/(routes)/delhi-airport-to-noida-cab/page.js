...
export const metadata = {
  ...
  keywords: 'delhi airport to noida cab, igi airport to noida taxi, delhi airport noida transfer, airport cab noida, greater noida cab',
  ...
  openGraph: {
    title: `Delhi Airport to Noida Cab | Fixed Fare \u20B9${data.fares.sedan.price} | No Surge`,
    description: `Book cab from Delhi IGI Airport to Noida. Fixed fare, no surge pricing, all sectors covered. ${data.time}.`,
    type: 'website', locale: 'en_IN', url: `https://www.trivenicabs.in/${SLUG}`, siteName: 'Triveni Cabs',
  },
  twitter: { card: 'summary_large_image', title: `Delhi Airport to Noida Cab | \u20B9${data.fares.sedan.price} Fixed`, description: 'IGI Airport to Noida cab. No surge, fixed fare guaranteed.' },
