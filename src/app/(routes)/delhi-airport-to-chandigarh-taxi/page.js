...
const SLUG = 'delhi-airport-to-chandigarh-taxi';
const data = airportRoutes[SLUG];

export const metadata = {
  title: `Delhi Airport to Chandigarh Taxi | Fixed \u20B9${data.fares.sedan.price} | Meet & Greet`,
  description: `Delhi Airport (IGI) to Chandigarh taxi. Fixed fare sedan \u20B9${data.fares.sedan.price}, SUV \u20B9${data.fares.suv.price}. All terminal pickup. Flight tracking, meet & greet. ${data.time}. Call 7668570551.`,
  keywords: 'delhi airport to chandigarh taxi, igi airport to chandigarh cab, delhi airport chandigarh transfer, airport taxi to chandigarh',
  ...
  openGraph: {
    title: `Delhi Airport to Chandigarh Taxi | Fixed Fare \u20B9${data.fares.sedan.price}`,
    description: `Book taxi from Delhi IGI Airport to Chandigarh. Fixed fare, flight tracking, expressway route. ${data.time} drive.`,
    type: 'website', locale: 'en_IN', url: `https://www.trivenicabs.in/${SLUG}`, siteName: 'Triveni Cabs',
  },
  twitter: { card: 'summary_large_image', title: `Delhi Airport to Chandigarh Taxi | \u20B9${data.fares.sedan.price} Fixed Fare`, description: 'IGI Airport to Chandigarh cab. Expressway route, fixed fare.' },
