...
export const metadata = {
  ...
  openGraph: { title: '15+ Places to Visit Near Lucknow by Car | Book Cab', description: 'Explore heritage and pilgrimage sites near Lucknow. Ayodhya, Varanasi, Prayagraj & more.', type: 'website', locale: 'en_IN', url: 'https://www.trivenicabs.in/places-to-visit-near-lucknow', siteName: 'Triveni Cabs', images: [{ url: '/images/sightseeing/Lucknow/Lucknow_hero_section.jpg', width: 1200, height: 630, alt: 'Places to Visit Near Lucknow' }] },
  twitter: { card: 'summary_large_image', title: '15+ Places to Visit Near Lucknow | Triveni Cabs', description: 'Heritage and spiritual trips from Lucknow. Call 7668570551.', images: ['/images/sightseeing/Lucknow/Lucknow_hero_section.jpg'] },
