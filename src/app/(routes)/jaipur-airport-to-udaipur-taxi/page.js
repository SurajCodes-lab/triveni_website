...
const SLUG = 'jaipur-airport-to-udaipur-taxi';
const data = airportRoutes[SLUG];

export const revalidate = false;

export const metadata = {
  title: `Jaipur Airport to Udaipur Taxi | Fixed \u20B9${data.fares.sedan.price} | Rajasthan Route`,
  description: `Jaipur Airport to Udaipur taxi. Fixed fare sedan \u20B9${data.fares.sedan.price}, SUV \u20B9${data.fares.suv.price}. Flight tracking, meet & greet. ${data.time} scenic drive. Call 7668570551.`,
  keywords: 'jaipur airport to udaipur taxi, jaipur airport udaipur cab, jaipur to udaipur transfer, rajasthan airport taxi',
  ...
  openGraph: {
    title: `Jaipur Airport to Udaipur Taxi | Fixed Fare \u20B9${data.fares.sedan.price}`,
    description: `Book taxi from Jaipur Airport to Udaipur. Scenic Rajasthan drive, Chittorgarh stop available. ${data.time}.`,
    type: 'website', locale: 'en_IN', url: `https://www.trivenicabs.in/${SLUG}`, siteName: 'Triveni Cabs',
  },
  twitter: { card: 'summary_large_image', title: `Jaipur Airport to Udaipur Taxi | \u20B9${data.fares.sedan.price}`, description: 'Jaipur to Udaipur airport transfer. Scenic Rajasthan route.' },
