...
export const metadata = {
  ...
  openGraph: { title: '15+ Places to Visit Near Gurgaon by Car | Book Cab', description: 'Weekend escapes from Gurgaon. Neemrana, Jaipur, Alwar, Rishikesh & more with cab fares.', type: 'website', locale: 'en_IN', url: 'https://www.trivenicabs.in/places-to-visit-near-gurgaon', siteName: 'Triveni Cabs', images: [{ url: '/images/sightseeing/Delhi/Delhi_hero_section.jpg', width: 1200, height: 630, alt: 'Places to Visit Near Gurgaon' }] },
  twitter: { card: 'summary_large_image', title: '15+ Places to Visit Near Gurgaon | Triveni Cabs', description: 'Weekend escapes from Millennium City. Call 7668570551.', images: ['/images/sightseeing/Delhi/Delhi_hero_section.jpg'] },
