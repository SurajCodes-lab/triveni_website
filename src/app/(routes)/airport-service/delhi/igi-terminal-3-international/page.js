          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
              {[
                ...
                { href: '/sightseeing/delhi', title: 'Delhi Sightseeing Tour', desc: 'Full-day Delhi tour for international tourists and visitors', icon: MapPin },
                { href: '/sightseeing/agra', title: 'Agra Sightseeing Tour', desc: 'Same-day Taj Mahal tour package from Delhi airport', icon: Star },
                { href: '/corporate-transportation-service', title: 'Corporate Cab Service', desc: 'Executive ground transport for business travelers', icon: Crown },
              ].map((service, idx) => (
