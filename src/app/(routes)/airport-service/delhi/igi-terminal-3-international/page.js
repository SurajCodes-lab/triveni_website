          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
              {[
                ...
                { href: '/outstation-cabs/delhi-to-agra-cab', title: 'Delhi to Agra Cab', desc: 'Direct outstation taxi from airport to Agra Taj Mahal', icon: Car },
                { href: '/outstation-cabs/delhi-to-jaipur-cab', title: 'Delhi to Jaipur Cab', desc: 'Golden Triangle first stop - comfortable ride to Jaipur', icon: Navigation },
