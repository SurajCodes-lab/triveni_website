          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
              {[
                ...
                { href: '/outstation-cabs/delhi-to-agra-cab', title: 'Delhi to Agra Cab', desc: 'Book outstation taxi from Delhi to Agra for Taj Mahal visit', icon: Car },
                { href: '/outstation-cabs/delhi-to-jaipur-cab', title: 'Delhi to Jaipur Cab', desc: 'Comfortable outstation ride from Delhi to Jaipur Pink City', icon: Navigation },
          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {[
                    { href: '/outstation-cabs/delhi-to-agra-cab', label: 'Delhi to Agra Cab' },
                    { href: '/outstation-cabs/delhi-to-jaipur-cab', label: 'Delhi to Jaipur Cab' },
                    { href: '/outstation-cabs/delhi-to-chandigarh-cab', label: 'Delhi to Chandigarh Cab' },
                    { href: '/outstation-cabs/delhi-to-shimla-cab', label: 'Delhi to Shimla Cab' },
                    { href: '/outstation-cabs/delhi-to-manali-cab', label: 'Delhi to Manali Cab' },
                    { href: '/outstation-cabs/delhi-to-haridwar-cab', label: 'Delhi to Haridwar Cab' },
                    { href: '/outstation-cabs/delhi-to-rishikesh-cab', label: 'Delhi to Rishikesh Cab' },
                    { href: '/outstation-cabs/delhi-to-dehradun-cab', label: 'Delhi to Dehradun Cab' },
                  ].map(link => (
                    <li key={link.href}><Link href={link.href} className="text-slate-400 hover:text-sky-400 text-sm transition-colors">{link.label}</Link></li>
                  ))}
                </ul>
