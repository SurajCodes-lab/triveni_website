...
const data = getCompareBySlug('jaisalmer-vs-jodhpur');
...
export const metadata = {
  ...
  alternates: { canonical: '/jaisalmer-vs-jodhpur' },
  openGraph: {
    title: data.title,
    description: data.metaDescription,
    type: 'article',
    locale: 'en_IN',
    url: 'https://www.trivenicabs.in/jaisalmer-vs-jodhpur',
...
export default function JaisalmerVsJodhpurPage() {
  const breadcrumbSchema = {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "itemListElement": [
      { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://www.trivenicabs.in" },
      { "@type": "ListItem", "position": 2, "name": "Jaisalmer vs Jodhpur", "item": "https://www.trivenicabs.in/jaisalmer-vs-jodhpur" },
    ],
  };
