...
const SLUG = 'delhi-airport-to-amritsar-taxi';
const data = airportRoutes[SLUG];

export const metadata = {
  title: `Delhi Airport to Amritsar Taxi | Fixed \u20B9${data.fares.sedan.price} | Golden Temple`,
  description: `Delhi Airport (IGI) to Amritsar taxi. Fixed fare sedan \u20B9${data.fares.sedan.price}, SUV \u20B9${data.fares.suv.price}. All terminal pickup. Flight tracking. ${data.time}. Call 7668570551.`,
  keywords: 'delhi airport to amritsar taxi, igi airport to amritsar cab, delhi airport amritsar transfer, airport taxi golden temple',
  ...
  openGraph: {
    title: `Delhi Airport to Amritsar Taxi | Fixed Fare \u20B9${data.fares.sedan.price}`,
    description: `Book taxi from Delhi IGI Airport to Amritsar. Fixed fare, Golden Temple direct drop. ${data.time} drive.`,
    type: 'website', locale: 'en_IN', url: `https://www.trivenicabs.in/${SLUG}`, siteName: 'Triveni Cabs',
  },
  twitter: { card: 'summary_large_image', title: `Delhi Airport to Amritsar Taxi | \u20B9${data.fares.sedan.price} Fixed Fare`, description: 'IGI Airport to Amritsar cab. Golden Temple direct drop.' },
