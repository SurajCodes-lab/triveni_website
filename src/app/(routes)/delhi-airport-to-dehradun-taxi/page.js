...
const SLUG = 'delhi-airport-to-dehradun-taxi';
const data = airportRoutes[SLUG];

export const metadata = {
  title: `Delhi Airport to Dehradun Taxi | Fixed \u20B9${data.fares.sedan.price} | Meet & Greet`,
  description: `Delhi Airport (IGI) to Dehradun taxi. Fixed fare sedan \u20B9${data.fares.sedan.price}, SUV \u20B9${data.fares.suv.price}. All terminal pickup. Flight tracking, meet & greet. ${data.time}. Call 7668570551.`,
  keywords: 'delhi airport to dehradun taxi, igi airport to dehradun cab, delhi airport dehradun transfer, airport taxi to dehradun',
  ...
  openGraph: {
    title: `Delhi Airport to Dehradun Taxi | Fixed Fare \u20B9${data.fares.sedan.price}`,
    description: `Book taxi from Delhi IGI Airport to Dehradun. Fixed fare, flight tracking, Mussoorie extension available. ${data.time} drive.`,
    type: 'website', locale: 'en_IN', url: `https://www.trivenicabs.in/${SLUG}`, siteName: 'Triveni Cabs',
  },
  twitter: { card: 'summary_large_image', title: `Delhi Airport to Dehradun Taxi | \u20B9${data.fares.sedan.price} Fixed Fare`, description: 'IGI Airport to Dehradun cab. Fixed fare, Mussoorie add-on available.' },
