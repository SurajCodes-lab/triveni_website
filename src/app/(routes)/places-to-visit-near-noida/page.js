...
export const metadata = {
  ...
  openGraph: { title: '15+ Places to Visit Near Noida by Car | Book Cab', description: 'Quick getaways from Noida NCR. Agra, Mathura, Jim Corbett, Rishikesh & more with cab fares.', type: 'website', locale: 'en_IN', url: 'https://www.trivenicabs.in/places-to-visit-near-noida', siteName: 'Triveni Cabs', images: [{ url: '/images/sightseeing/Delhi/Delhi_hero_section.jpg', width: 1200, height: 630, alt: 'Places to Visit Near Noida' }] },
  twitter: { card: 'summary_large_image', title: '15+ Places to Visit Near Noida | Triveni Cabs', description: 'NCR weekend getaways from Noida. Call 7668570551.', images: ['/images/sightseeing/Delhi/Delhi_hero_section.jpg'] },
