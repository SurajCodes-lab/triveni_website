...
export const metadata = {
  ...
  keywords: 'same day shimla tour from chandigarh, chandigarh to shimla one day trip, chandigarh to shimla cab, shimla day trip',
  authors: [{ name: 'Triveni Cabs' }],
  metadataBase: new URL('https://www.trivenicabs.in'),
  alternates: { canonical: '/same-day-shimla-from-chandigarh' },
  openGraph: {
    title: 'Same Day Shimla Tour from Chandigarh | ₹3,500 AC Cab',
    description: 'Chandigarh to Shimla day trip. The Ridge, Mall Road, Kufri. AC sedan ₹3,500.',
    type: 'website', locale: 'en_IN', url: 'https://www.trivenicabs.in/same-day-shimla-from-chandigarh', siteName: 'Triveni Cabs',
  },
  twitter: { card: 'summary_large_image', title: 'Shimla Day Trip from Chandigarh | ₹3,500', description: 'Queen of Hills day trip. Book now!' },
