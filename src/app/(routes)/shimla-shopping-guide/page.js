...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: '/images/sightseeing/Shimla/shimla_hero_section.jpg', width: 1200, height: 630, alt: 'Shimla Shopping Guide' }],
  },
  twitter: {
    ...
    creator: '@trivenicabs',
    site: '@trivenicabs',
    images: ['/images/sightseeing/Shimla/shimla_hero_section.jpg'],
  },
