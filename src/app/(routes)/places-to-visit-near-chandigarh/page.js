...
export const metadata = {
  ...
  openGraph: { title: '15+ Places to Visit Near Chandigarh by Car | Book Cab', description: 'Hill stations and heritage near Chandigarh. Shimla, Kasauli, Manali & more with cab fares.', type: 'website', locale: 'en_IN', url: 'https://www.trivenicabs.in/places-to-visit-near-chandigarh', siteName: 'Triveni Cabs', images: [{ url: '/images/citypage_hero_section_image.jpg', width: 1200, height: 630, alt: 'Places to Visit Near Chandigarh' }] },
  twitter: { card: 'summary_large_image', title: '15+ Places to Visit Near Chandigarh | Triveni Cabs', description: 'Hills and heritage trips from Chandigarh. Call 7668570551.', images: ['/images/citypage_hero_section_image.jpg'] },
