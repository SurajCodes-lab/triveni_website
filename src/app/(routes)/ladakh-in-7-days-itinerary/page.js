...
const data = getItinerary('ladakh-in-7-days-itinerary');
...
export const metadata = {
  ...
  alternates: { canonical: '/ladakh-in-7-days-itinerary' },
  openGraph: {
    title: data.metaTitle,
    description: data.metaDescription,
    type: 'website',
    locale: 'en_IN',
    url: 'https://www.trivenicabs.in/ladakh-in-7-days-itinerary',
...
export default function Page() {
  const related = getRelatedItineraries('ladakh-in-7-days-itinerary', 4);
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": data.title, "item": `https://www.trivenicabs.in/ladakh-in-7-days-itinerary` },
    ],
  };
