...
const touristSpotsData = {
  Jaipur: {
    ...
    spots: [
      { name: "Amber Fort", description: "Historic fort overlooking Maota Lake, known for its artistic Hindu style elements with large ramparts, series of gates and cobbled paths.", image: "/images/sightseeing/Jaipur/amber_fort.jpg", icon: Landmark, highlight: "UNESCO Heritage" },
      { name: "Hawa Mahal", description: "The Palace of Winds is a five-story palace built in 1799 with a unique honeycomb facade of 953 small windows to allow royal ladies to observe street festivals.", image: "/images/sightseeing/Jaipur/Hawa_Mahal.jpg", icon: Camera, highlight: "Iconic Landmark" },
      { name: "City Palace", description: "A complex of courtyards, gardens and buildings, the impressive City Palace is right in the center of the Old City, a perfect blend of Rajasthani and Mughal architecture.", image: "/images/sightseeing/Jaipur/city_palace.jpg", icon: Landmark, highlight: "Royal Heritage" },
      { name: "Jantar Mantar", description: "An astronomical observation site built in the early 18th century that features the world's largest stone sundial and is a UNESCO World Heritage site.", image: "/images/sightseeing/Jaipur/jantar_mantar.jpg", icon: Compass, highlight: "UNESCO Site" },
      { name: "Jal Mahal", description: "The Water Palace sits in the middle of Man Sagar Lake and appears to float on the water when the lake is full. The palace has a scenic view of the hills.", image: "/images/sightseeing/Jaipur/Jal_Mahal.jpg", icon: Camera, highlight: "Lake Palace" },
      { name: "Nahargarh Fort", description: "Standing on the edge of the Aravalli Hills, this fort offers breathtaking panoramic views of the Pink City and was originally built as a defense fortress.", image: "/images/sightseeing/Jaipur/Nahargarh_Fort.jpg", icon: Landmark, highlight: "Panoramic Views" },
    ],
  },
  Udaipur: {
    ...
    spots: [
      { name: "Lake Pichola", description: "Artificial fresh water lake created in 1362 AD, named after the nearby Picholi village. The lake houses several islands including Jag Niwas and Jag Mandir.", image: "/images/sightseeing/Udaipur/Lake_Pichola.jpg", icon: Compass, highlight: "Heritage Lake" },
      { name: "City Palace", description: "Built over a period of nearly 400 years, the City Palace is a majestic architectural marvel towering over Lake Pichola with its balconies, towers and cupolas.", image: "/images/sightseeing/Udaipur/City_Palace.jpg", icon: Landmark, highlight: "400-Year Marvel" },
      { name: "Sajjangarh Palace", description: "Also known as the Monsoon Palace, this hilltop royal residence offers spectacular views of the city's lakes, palaces and surrounding countryside.", image: "/images/sightseeing/Udaipur/Udaipur_hero_section.jpg", icon: Camera, highlight: "Monsoon Palace" },
      { name: "Jagdish Temple", description: "Built in 1651, this Indo-Aryan style temple dedicated to Lord Vishnu is a major monument in Udaipur with beautifully carved pillars, walls and ceilings.", image: "/images/sightseeing/Udaipur/Jagdish_Temple.jpg", icon: Heart, highlight: "Sacred Temple" },
      { name: "Fateh Sagar Lake", description: "The second artificial lake of Udaipur, surrounded by hills and woods. The lake has three islands and is a popular recreational spot.", image: "/images/sightseeing/Udaipur/Fateh_Sagar_Lake.jpg", icon: Compass, highlight: "Nature Retreat" },
      { name: "Saheliyon Ki Bari", description: "Garden of the Maidens, built for the royal ladies who came in princess's dowry. Features beautiful fountains, kiosks, marble pavilions and lotus pools.", image: "/images/sightseeing/Udaipur/Jag_Mandir.jpg", icon: Camera, highlight: "Royal Garden" },
    ],
  },
  Jodhpur: {
    ...
    spots: [
      { name: "Mehrangarh Fort", description: "One of the largest forts in India, standing 400 feet above the city with impressive views. Houses several palaces, extensive courtyards and historic artifacts.", image: "/images/sightseeing/Jodhpur/Mehrangarh Fort.jpg", icon: Landmark, highlight: "India's Largest" },
      { name: "Jaswant Thada", description: "Royal cenotaph built in marble, commemorating Maharaja Jaswant Singh II. Known for its intricate carvings and peaceful setting with a multi-tiered garden.", image: "/images/sightseeing/Jodhpur/Jaswant Thada.jpg", icon: Camera, highlight: "Marble Cenotaph" },
      { name: "Umaid Bhawan Palace", description: "One of the world's largest private residences, part of which is managed by Taj Hotels. Built between 1928 and 1943, displays a blend of eastern and western architectural influences.", image: "/images/sightseeing/Jodhpur/Umaid Bhawan Palace.jpg", icon: Landmark, highlight: "Taj Heritage" },
      { name: "Clock Tower & Sardar Market", description: "Vibrant marketplace in the heart of the old city, centered around a prominent clock tower. Offers textiles, silver jewelry, handicrafts and spices.", image: "/images/sightseeing/Jodhpur/Clock Tower _Bustling Sardar Market in Jodhpur.jpg", icon: Compass, highlight: "Local Market" },
      { name: "Mandore Gardens", description: "Ancient town that was Marwar's capital before Jodhpur. Features cenotaphs of Jodhpur's rulers, a Hall of Heroes, temple and museum set in beautiful gardens.", image: "/images/sightseeing/Jodhpur/Mandore Gardens jodhpur.jpg", icon: Camera, highlight: "Ancient Capital" },
    ],
  },
};
