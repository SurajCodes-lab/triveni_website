...
const data = getItinerary('rishikesh-in-2-days-itinerary');
...
export const metadata = {
  ...
  alternates: { canonical: '/rishikesh-in-2-days-itinerary' },
  openGraph: {
    title: data.metaTitle,
    description: data.metaDescription,
    type: 'website',
    locale: 'en_IN',
    url: 'https://www.trivenicabs.in/rishikesh-in-2-days-itinerary',
...
export default function Page() {
  const related = getRelatedItineraries('rishikesh-in-2-days-itinerary', 4);
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": data.title, "item": `https://www.trivenicabs.in/rishikesh-in-2-days-itinerary` },
    ],
  };
