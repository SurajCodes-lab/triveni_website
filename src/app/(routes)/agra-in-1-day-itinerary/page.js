...
const data = getItinerary('agra-in-1-day-itinerary');
...
export const metadata = {
  ...
  alternates: { canonical: '/agra-in-1-day-itinerary' },
  openGraph: {
    title: data.metaTitle,
    description: data.metaDescription,
    type: 'website',
    locale: 'en_IN',
    url: 'https://www.trivenicabs.in/agra-in-1-day-itinerary',
...
export default function Page() {
  const related = getRelatedItineraries('agra-in-1-day-itinerary', 4);
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": data.title, "item": `https://www.trivenicabs.in/agra-in-1-day-itinerary` },
    ],
  };
