...
const SLUG = 'delhi-airport-to-haridwar-taxi';
const data = airportRoutes[SLUG];

export const metadata = {
  title: `Delhi Airport to Haridwar Taxi | Fixed \u20B9${data.fares.sedan.price} | Meet & Greet`,
  description: `Delhi Airport (IGI) to Haridwar taxi. Fixed fare sedan \u20B9${data.fares.sedan.price}, SUV \u20B9${data.fares.suv.price}. All terminal pickup. Flight tracking, meet & greet. ${data.time}. Call 7668570551.`,
  keywords: 'delhi airport to haridwar taxi, igi airport to haridwar cab, delhi airport haridwar transfer, airport taxi to haridwar',
  ...
  openGraph: {
    title: `Delhi Airport to Haridwar Taxi | Fixed Fare \u20B9${data.fares.sedan.price}`,
    description: `Book reliable taxi from Delhi IGI Airport to Haridwar. Fixed fare, flight tracking, all terminal pickup. ${data.time} drive.`,
    type: 'website', locale: 'en_IN', url: `https://www.trivenicabs.in/${SLUG}`, siteName: 'Triveni Cabs',
  },
  twitter: { card: 'summary_large_image', title: `Delhi Airport to Haridwar Taxi | \u20B9${data.fares.sedan.price} Fixed Fare`, description: 'IGI Airport to Haridwar cab. Fixed fare, flight tracking, meet & greet.' },
