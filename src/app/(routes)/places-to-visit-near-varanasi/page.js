...
export const metadata = {
  ...
  openGraph: { title: '15+ Places to Visit Near Varanasi by Car | Book Cab', description: 'Spiritual trails from Varanasi. Sarnath, Bodhgaya, Prayagraj, Ayodhya & more with cab fares.', type: 'website', locale: 'en_IN', url: 'https://www.trivenicabs.in/places-to-visit-near-varanasi', siteName: 'Triveni Cabs', images: [{ url: '/images/citypage_hero_section_image.jpg', width: 1200, height: 630, alt: 'Places to Visit Near Varanasi' }] },
  twitter: { card: 'summary_large_image', title: '15+ Places to Visit Near Varanasi | Triveni Cabs', description: 'Spiritual and heritage trips from Varanasi. Call 7668570551.', images: ['/images/citypage_hero_section_image.jpg'] },
