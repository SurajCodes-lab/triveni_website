...
const data = getItinerary('mathura-vrindavan-1-day-package');
...
export const metadata = {
  ...
  alternates: { canonical: '/mathura-vrindavan-1-day-package' },
  openGraph: {
    title: data.metaTitle,
    description: data.metaDescription,
    type: 'website',
    locale: 'en_IN',
    url: 'https://www.trivenicabs.in/mathura-vrindavan-1-day-package',
...
export default function Page() {
  const related = getRelatedItineraries('mathura-vrindavan-1-day-package', 4);
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": data.title, "item": `https://www.trivenicabs.in/mathura-vrindavan-1-day-package` },
    ],
  };
