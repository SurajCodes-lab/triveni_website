...
const SLUG = 'delhi-airport-to-rishikesh-taxi';
const data = airportRoutes[SLUG];

export const revalidate = false;

export const metadata = {
  title: `Delhi Airport to Rishikesh Taxi | Fixed \u20B9${data.fares.sedan.price} | Meet & Greet`,
  description: `Delhi Airport (IGI) to Rishikesh taxi. Fixed fare sedan \u20B9${data.fares.sedan.price}, SUV \u20B9${data.fares.suv.price}. All terminal pickup. Flight tracking, meet & greet. ${data.time}. Call 7668570551.`,
  keywords: 'delhi airport to rishikesh taxi, igi airport to rishikesh cab, delhi airport rishikesh transfer, airport taxi to rishikesh, yoga capital taxi',
  ...
  openGraph: {
    title: `Delhi Airport to Rishikesh Taxi | Fixed Fare \u20B9${data.fares.sedan.price}`,
    description: `Book taxi from Delhi IGI Airport to Rishikesh. Fixed fare, flight tracking. ${data.time} drive to Yoga Capital.`,
    type: 'website', locale: 'en_IN', url: `https://www.trivenicabs.in/${SLUG}`, siteName: 'Triveni Cabs',
  },
  twitter: { card: 'summary_large_image', title: `Delhi Airport to Rishikesh Taxi | \u20B9${data.fares.sedan.price} Fixed Fare`, description: 'IGI Airport to Rishikesh cab. Direct to ashram or hotel.' },
