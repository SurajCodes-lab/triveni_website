...
const SLUG = 'delhi-airport-to-mathura-taxi';
const data = airportRoutes[SLUG];

export const revalidate = false;

export const metadata = {
  title: `Delhi Airport to Mathura Taxi | Fixed \u20B9${data.fares.sedan.price} | Expressway Route`,
  description: `Delhi Airport (IGI) to Mathura taxi via Yamuna Expressway. Fixed fare sedan \u20B9${data.fares.sedan.price}, SUV \u20B9${data.fares.suv.price}. Flight tracking, meet & greet. ${data.time}. Call 7668570551.`,
  keywords: 'delhi airport to mathura taxi, igi airport to mathura cab, delhi airport mathura transfer, airport taxi to mathura vrindavan',
  ...
  openGraph: {
    title: `Delhi Airport to Mathura Taxi | Fixed Fare \u20B9${data.fares.sedan.price}`,
    description: `Book taxi from Delhi IGI Airport to Mathura via Yamuna Expressway. Fixed fare, Vrindavan add-on available. ${data.time}.`,
    type: 'website', locale: 'en_IN', url: `https://www.trivenicabs.in/${SLUG}`, siteName: 'Triveni Cabs',
  },
  twitter: { card: 'summary_large_image', title: `Delhi Airport to Mathura Taxi | \u20B9${data.fares.sedan.price} Fixed Fare`, description: 'IGI Airport to Mathura cab via Yamuna Expressway.' },
