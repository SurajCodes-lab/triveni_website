// Tourist attractions data for different cities
...
// Helper function to get cities with tourist attractions
export const getCitiesWithAttractions = () => {
  return Object.keys(touristAttractions);
};

// Helper function to check if a city has tourist attractions
export const hasTouristAttractions = (city) => {
  return touristAttractions.hasOwnProperty(city.toLowerCase());
};

// Helper function to get attractions for a city
export const getAttractionsForCity = (city) => {
  return touristAttractions[city.toLowerCase()] || [];
};
