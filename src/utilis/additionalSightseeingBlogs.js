...
export const additionalSightseeingBlogs = [
  ...
  {
    id: 'sight-9',
    slug: 'corbett-ranthambore-wildlife-safari-guide-2026',
    title: 'Jim Corbett vs Ranthambore 2026: Best Tiger Safari Guide',
    excerpt: 'Compare India two best tiger reserves. Jim Corbett and Ranthambore safari guide. Booking tips, best zones, and wildlife spotting.',

    relatedTours: [
      { id: "corbett", name: "Jim Corbett Safari", slug: "jim-corbett", city: "delhi", price: "₹12,000" },
      { id: "ranthambore", name: "Ranthambore Safari", slug: "ranthambore", city: "jaipur", price: "₹15,000" }
    ],

    relatedDestinations: [
      { name: "Jim Corbett", slug: "jim-corbett", type: "destination" },
      { name: "Ranthambore", slug: "ranthambore", type: "destination" }
    ],

    primaryCTA: {
      text: "Book Safari Tour",
      url: "/sightseeing/jim-corbett",
      description: "Tiger spotting adventure",
      price: "Starting ₹10,000"
    },

    content: `
      <p>India is home to 70% of the world's tigers, and <strong>Jim Corbett</strong> and <strong>Ranthambore</strong> are the best places to spot these majestic creatures. Our <a href="/sightseeing/jim-corbett" class="text-blue-600 hover:underline font-semibold">wildlife safari tours</a> maximize your tiger sighting chances.</p>

      <h2>Jim Corbett National Park</h2>
      <p>India's oldest national park (1936), named after hunter-conservationist Jim Corbett.</p>
      <ul>
        <li><strong>Location:</strong> Uttarakhand, 260 km from Delhi</li>
        <li><strong>Tigers:</strong> 200+ tigers</li>
        <li><strong>Best Zones:</strong> Dhikala, Bijrani, Jhirna</li>
        <li><strong>Season:</strong> Nov 15 - June 15 (varies by zone)</li>
        <li><strong>Safari Cost:</strong> ₹5,000-8,000 per jeep</li>
      </ul>

      <h2>Ranthambore National Park</h2>
      <p>Famous for tigers among ancient ruins - most photogenic tiger destination.</p>
      <ul>
        <li><strong>Location:</strong> Rajasthan, 180 km from Jaipur</li>
        <li><strong>Tigers:</strong> 80+ tigers</li>
        <li><strong>Best Zones:</strong> Zone 3-5 (lakes and fort)</li>
        <li><strong>Season:</strong> October 1 - June 30</li>
        <li><strong>Safari Cost:</strong> ₹5,000-10,000 per jeep</li>
      </ul>
      ...
      <table class="w-full my-6 border-collapse border border-gray-300">
        <thead>
          <tr class="bg-gray-100">
            ...
            <th class="border border-gray-300 p-3 text-left">Jim Corbett</th>
            <th class="border border-gray-300 p-3 text-left">Ranthambore</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td class="border border-gray-300 p-3">Tiger Sighting</td>
            <td class="border border-gray-300 p-3">Moderate</td>
            <td class="border border-gray-300 p-3">Higher</td>
          </tr>
          <tr>
            <td class="border border-gray-300 p-3">Scenery</td>
            <td class="border border-gray-300 p-3">River, forest</td>
            <td class="border border-gray-300 p-3">Fort, lakes</td>
          </tr>
          <tr>
            <td class="border border-gray-300 p-3">Crowd</td>
            <td class="border border-gray-300 p-3">Less</td>
            <td class="border border-gray-300 p-3">More</td>
          </tr>
          <tr>
            <td class="border border-gray-300 p-3">Other Wildlife</td>
            <td class="border border-gray-300 p-3">Elephants</td>
            <td class="border border-gray-300 p-3">Leopards</td>
          </tr>
        </tbody>
      </table>
      ...
      <h2>Safari Tips</h2>
      <ul>
        <li>Book safaris 90-120 days in advance online</li>
        <li>Morning safaris (6 AM) best for sightings</li>
        <li>Wear earthy colors (khaki, green, brown)</li>
        <li>Carry binoculars and camera with zoom</li>
        <li>Maintain silence during safaris</li>
      </ul>

      <h2>Best Time for Tiger Safari</h2>
      <p><strong>March to June:</strong> Best sightings (animals near water)</p>
      <p><strong>November to February:</strong> Pleasant weather, moderate sightings</p>

      <div class="my-8 p-6 bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-600 rounded-r-lg">
        <h3 class="text-2xl font-bold mb-3 text-gray-800">Spot the Royal Bengal Tiger!</h3>
        <p class="mb-4 text-gray-700">Book your wildlife safari for an unforgettable experience!</p>
        <a href="/sightseeing/jim-corbett" class="inline-block bg-green-600 text-white px-8 py-3 rounded-lg font-bold hover:bg-green-700 transition-colors shadow-md">Book Safari</a>
      </div>

      <p>Plan your safari! <a href="/contact" class="text-blue-600 hover:underline font-semibold">Contact us</a> or call <strong>7668570551</strong>!</p>
    `,
    ...
    category: "Wildlife",
    tags: ["Jim Corbett", "Ranthambore", "Tiger Safari", "Wildlife", "National Park"],
    keywords: ["jim corbett safari", "ranthambore tiger", "wildlife safari india", "tiger spotting", "best tiger reserve"],
    featured: false
  },
